...
export default function PlayerList() {
  ...
  useEffect(() => {
    filterPlayersList();
  }, [searchTerm, filterRegion, filterBuildType, players]);
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-amber-200/70">Lista de Guerreiros Registrados</p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                {player.server && (
                  <p className="text-amber-300/60 text-sm">{player.server}</p>
                )}
              </div>
              {player.level && (
            ...
            <div className="space-y-2 text-sm">
              {player.main_style && (
                <div className="flex justify-between">
                  <span className="text-amber-300/60">Estilo:</span>
                  <span className="text-amber-200">{player.main_style}</span>
                </div>
              )}
              {player.build_type && (
                <div className="flex justify-between">
              ...
              {player.region && (
                <div className="flex justify-between">
                  <span className="text-amber-300/60">Região:</span>
                  <span className="text-amber-200">{player.region}</span>
                </div>
              )}
              {player.discord_id && (
                <div className="flex justify-between">
