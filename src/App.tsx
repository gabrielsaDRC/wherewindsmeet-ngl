...
import { Home, UserPlus, Users, FileText, Edit, Shield } from 'lucide-react';
...
type Page = 'home' | 'register' | 'list' | 'edit' | 'blog' | 'admin';
        ...
        <nav className="bg-black/30 border-b border-amber-700/30 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              >
                <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-red-400 hover:from-amber-300 hover:to-red-300 transition-all">
                  逐风行者
                </span>
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <ActionCard
            ...
            gradient="from-slate-900/60 to-amber-900/60"
          />
        </div>
